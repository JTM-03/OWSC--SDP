...
export function StaffManagement({ onBack }: StaffManagementProps) {
  ...
  // This ensures that if allStaff is missing, it defaults to an empty array []
const [allStaff, setAllStaff] = useState<APIStaffMember[]>([]); // Initializing with an empty array
